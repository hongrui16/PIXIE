...
def crop_resize_image_batch(image, bbox, scale, target_size):
    ...
    return cropped_images, scales_x, scales_y, left_pad, top_pad
...
if __name__ == '__main__':
    ...
    output_images, scales_x, scales_y, left_pad, top_pad = crop_resize_image_batch(images, bboxes, scale, target_size)
