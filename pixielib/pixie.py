...
class PIXIE(nn.Module):
    def __init__(self, config=None, device='cpu', freeze_model=False, mode='train', logger=None):
    ...
    def _create_model(self, mode = 'train'):
        # self.model_dict = {}
